...
import Week14App from "./Week14App.jsx";
import Week15App from "./Week15App.jsx";           // ★ Week 15 추가
...
const weeks = {
  KR: [
    ...
    { id: 14, title: "Week 14", subtitle: "미세유체역학, MEMS & NEMS", topics: ["Reynolds·Péclet '저주' & 스케일 법칙", "NS 솔버 (Poiseuille · EOF · lid-driven cavity)", "Lab-on-a-chip 디지털 트윈 (전기영동 · 마이크로믹서)", "MEMS pull-in & NEMS 공진 질량 센서", "Knudsen 수 · 연속체 가정 붕괴", "Python 솔버 (FD · ψ-ω · 이류-확산)"], color: "#10b981" },
    // ★ Week 15 메타데이터 추가
    { id: 15, title: "Week 15", subtitle: "유체역학 × AI: PINN · Neural Operator · Neural Rendering", topics: ["AI 기반 PDE 풀이의 패러다임", "PINN: PDE 잔차를 손실로 (역문제 포함)", "브라우저 실시간 PINN 학습 (TensorFlow.js)", "Neural Operator: 함수→함수 학습 (Darcy 인터랙티브)", "Neural Field & Rendering: 측정→3D 복원", "Taylor–Green vortex 시간 진화 시각화", "방법 선택 가이드 + 종합 퀴즈"], color: "#a855f7" },
  ],
  EN: [
    ...
    { id: 14, title: "Week 14", subtitle: "Microfluidics, MEMS & NEMS", topics: ["Reynolds·Péclet 'curse' & scaling laws", "NS solvers (Poiseuille · EOF · lid-driven cavity)", "Lab-on-a-chip digital twin (electrophoresis · micromixer)", "MEMS pull-in & NEMS resonant mass sensor", "Knudsen number · continuum breakdown", "Python solvers (FD · ψ-ω · advection-diffusion)"], color: "#10b981" },
    // ★ Week 15 EN entry (KR 컴포넌트 임시 재사용)
    { id: 15, title: "Week 15", subtitle: "Fluid Mechanics × AI: PINN · Neural Operator · Neural Rendering", topics: ["Paradigm of AI-based PDE solvers", "PINN: PDE residual as loss (incl. inverse problems)", "Live PINN training in browser (TensorFlow.js)", "Neural Operator: function→function learning (interactive Darcy)", "Neural Field & Rendering: measurements→3D reconstruction", "Taylor–Green vortex time-evolution visualizer", "Method-selection guide + concept quiz"], color: "#a855f7" },
  ],
};

const comps = {
  KR: { 1: Week1App, 2: Week2App, 3: Week3App, 4: Week4App, 5: Week5App, 6: Week6App, 8: Week8App, 9: Week9App, 10: Week10App, 11: Week11App, 12: Week12App, 13: Week13App, 14: Week14App, 15: Week15App },
  EN: { 1: Week1App_EN, 2: Week2App_EN, 3: Week3App_EN, 4: Week4App_EN, 5: Week5App, 6: Week6App, 8: Week8App, 9: Week9App, 10: Week10App, 11: Week11App, 12: Week12App, 13: Week13App, 14: Week14App, 15: Week15App },
};
