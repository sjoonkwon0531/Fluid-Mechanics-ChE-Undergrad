...
const weeks = [
  ...
  },
  {
    id: 3,
    title: "Week 03",
    subtitle: "Momentum Balance & Fluid Friction in Pipes",
    topics: ["Momentum balance (force, convection, angular)", "Reynolds number & flow regimes", "Laminar flow & Hagen-Poiseuille law", "Frictional dissipation & lumped K.E.", "Wedge CFD simulation (LBM D2Q9)"],
    color: "#8b5cf6",
  ...
  },
  {
    id: 4,
    title: "Week 04",
    subtitle: "Friction Factor, Pipe Systems & Creeping Flow",
    topics: ["Shear stress models (laminar vs turbulent)", "Fanning friction factor & Moody chart", "Pipe fittings & equivalent length", "Compressible gas pipeline flow", "d'Alembert paradox & Stokes law"],
    color: "#f97316",
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        gap: 20, maxWidth: 1280, width: "100%",
        position: "relative",
      }}>
        {weeks.map((w, i) => (
          <button
...
export default function App() {
  ...
  if (week === 3) return <Week3App />;
  if (week === 4) return <Week4App />;
