  ...
  return (
    <div className="min-h-screen" style={{ background: C.bg, color: C.text }}>
      ...
      <header className="sticky top-0 z-50 backdrop-blur-md" style={{ background: `${C.bg}ee`, borderBottom: `1px solid ${C.border}` }}>
        <div className="max-w-4xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between mb-2">
            <div><h1 className="text-lg font-bold" style={{ color: C.accent, fontFamily: "'Outfit',sans-serif" }}>화공유체역학</h1><p className="text-xs" style={{ color: C.textDim }}>Week 6 · Differential Equations & Vector Calculus · SKKU SPMDL</p></div>
            <div className="text-right text-xs" style={{ color: C.textDim }}><div>Prof. S. Joon Kwon</div><div style={{ color: C.accent }}>6주차 학습 도우미</div></div>
          </div>
      ...
      <footer className="text-center py-6 text-xs" style={{ color: C.textDim, borderTop: `1px solid ${C.border}` }}>
        ...
        <p className="mt-1" style={{ color: C.accentDim }}>화공유체역학 Week 6 학습 도우미 · 2025 Spring</p>
      </footer>
    </div>
  );
}
