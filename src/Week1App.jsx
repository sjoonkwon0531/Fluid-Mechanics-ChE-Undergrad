...
// ─── MAIN APP ───
export default function Week1App() {
  ...
  return (
    <div style={{
      ...
      <nav style={{
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "flex", gap: 2, alignItems: "center" }}>
          <button onClick={() => window.__backToHome && window.__backToHome()} style={{
            padding: "10px 12px", fontSize: 13, fontWeight: 600, cursor: "pointer",
            background: "transparent", border: "none", color: theme.accentLight,
            whiteSpace: "nowrap", marginRight: 8,
          }}>← All Weeks</button>
          <div style={{ width: 1, height: 20, background: theme.border, marginRight: 4 }} />
          {tabs.map(t => (
